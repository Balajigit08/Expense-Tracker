...
def expense_category_summary(request):
    ...
    category_names = list(set(expense.category.name for expense in expenses))

    def get_expense_category_amount(category_name):
        return sum(item.amount for item in expenses if item.category.name == category_name)

    for category_name in category_names:
        final_data[category_name] = get_expense_category_amount(category_name)
